...
const StudentDashboard = () => {
  ...
  const stats = [
    { label: "Credit Score", value: 750, max: 850, icon: TrendingUp, color: "text-success" },
    { label: "Wallet Balance", value: "₹2,450", icon: Wallet, color: "text-primary" },
    { label: "Attendance", value: "87%", icon: Calendar, color: "text-accent" },
    { label: "Books Issued", value: "3", icon: BookOpen, color: "text-warning" },
  ];

  const recentTransactions = [
    { id: 1, type: "Canteen", amount: -120, time: "2 hours ago", location: "Main Cafeteria" },
    { id: 2, type: "Library Fine", amount: -50, time: "Yesterday", location: "Central Library" },
    { id: 3, type: "Wallet Recharge", amount: 1000, time: "2 days ago", location: "Online" },
    { id: 4, type: "Canteen", amount: -85, time: "3 days ago", location: "Food Court" },
  ];

  const quickActions = [
    { title: "Pay Fees", icon: CreditCard, path: "/dashboard/student/fees", gradient: "from-primary to-accent" },
    { title: "Attendance", icon: Calendar, path: "/dashboard/student/attendance", gradient: "from-accent to-primary" },
    { title: "Library", icon: BookOpen, path: "/dashboard/student/library", gradient: "from-success to-primary" },
    { title: "Gate Entry", icon: DoorOpen, path: "/dashboard/student/gate-entry", gradient: "from-warning to-accent" },
    { title: "Events", icon: PartyPopper, path: "/dashboard/student/events", gradient: "from-primary to-success" },
    { title: "Profile", icon: User, path: "/dashboard/student/profile", gradient: "from-accent to-warning" },
  ];
